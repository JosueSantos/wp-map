...
function cc_mapa_shortcode($atts) {
    ...
    wp_enqueue_style('cc-mapa-css', CC_URL . 'assets/css/mapa.css', [], '1.3');
    ...
    wp_enqueue_script('cc-mapa', CC_URL . 'assets/js/mapa.js', ['leaflet-js', 'leaflet-markercluster-js'], '2.0', true);
