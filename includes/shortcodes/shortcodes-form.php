...
add_shortcode('mapa_form_comunidade', function () {
    ...
    <div class="max-w-5xl mx-auto bg-white shadow-xl rounded-2xl p-4 sm:p-8 space-y-6">
        ...
        <div class="space-y-2">
            ...
            <p class="text-gray-500 text-sm">Fluxo guiado por etapas para facilitar o preenchimento em qualquer dispositivo.</p>
        </div>
        ...
        <div>
            ...
            <div id="etapas-cadastro" class="mt-3 grid grid-cols-2 md:grid-cols-4 gap-2 text-xs sm:text-sm">
